...
a persistence unit "empelectricaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "empelectrica/pom.xml":
...
artifact ("empelectrica.war") is already built. You can build
